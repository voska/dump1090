...
function refreshSelected() {
  ...
  if (selected && selected.flight == "") {
      html += '<tr><td colspan="' + columns + '" id="selectedinfotitle"><b>N/A (' +
        '<a href="http://www.airframes.org?q=' + selected.icao + '">' + selected.icao + "</a>" + ')</b>';
  } else if (selected && selected.flight != "" && selected.flight[0] == "N") {
      html += '<tr><td colspan="' + columns + '" id="selectedinfotitle"><b>' +
          '<a href="http://flightaware.com/resources/registration/' + selected.flight + '">' + selected.flight + "</a>" + '</b>';
  } else if (selected && selected.flight != "" && selected.flight[0] != "N") {
      html += '<tr><td colspan="' + columns + '" id="selectedinfotitle"><b>' +
          '<a href="https://www.google.com/search?q=' + selected.flight + '">' + selected.flight + "</a>" + '</b>';
  } else {
  ...
  if (selected) {
        html += '<td>ICAO (hex): ' + '<a href="http://www.airframes.org?q=' + selected.icao + '">' + selected.icao + "</a>" + '</td></tr>';
    } else {
